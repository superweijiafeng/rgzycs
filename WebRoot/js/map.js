//创建和初始化地图函数：
function initMap(id,px,py,markerTitle,markerContent) {
	//id: id of html object
	//px, py: position of the marker
	//title, content: that of the marker
	
	createMap(id,px,py);//创建地图
	setMapEvent();//设置地图事件
...
initMap("dituContent",120.577824,32.386929,"如皋智源财税咨询有限公司","如皋市大润发对面,江苏银行北隔壁");//创建和初始化地图
